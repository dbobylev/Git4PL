...
namespace Git4PL.PLSqlDeveloper.IDECallBacks
{
    ...
    public static partial class Callbacks
    {
        ...
        public static int Version()
        {
            ...
            logger.Info("Версия PL/SQL Developer: {0}", version);
            return version;
        }
        ...
        {
            logger.Trace($"Запрос на создание кнопки меню ID={ID}, Index={Index}, Name={Name}, BitmapFile={BitmapFile} BitmapHandle={(long)BitmapHandle}");
